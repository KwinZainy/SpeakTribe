...
const Hero = () => {
  return (
    <div className=' flex justify-center py-24 max-tablet:flex-col-reverse max-w-[1800px] m-auto min-desktop:justify-center'>
        <section className=' w-[50%] flex flex-col gap-2 justify-center
         max-tablet:items-center max-tablet:w-full max-tablet:mt-6 '> 
          ...
          <div className=' flex gap-4 mx-auto max-tablet:pl-4 max-tablet:mt-3 '>
        ...
        <section >
          <img src="./tribe.jpg" alt=""  className='w-[500px] max-tablet:w-full p-5 ' />
